...
export const translations: Record<Language, Translations> = {
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: "Pick an available number from your selected pool, secure your ticket via Telebirr or CBE Birr, and verify the physical draw live on video. 100% transparent and verified.",
  ...
  am: {
    ...
    hero: {
      ...
      subtitle: "ከ1 እስከ መረጡት የተሳታፊ ገደብ የሚወዱትን ቁጥር ይምረጡ፣ በቴሌብር ወይም በሲቢኢ ብር ይክፈሉ፣ በእጣው ቀን የቀጥታ ቪዲዮ እጣውን ይመልከቱ። 100% ግልጽና አስተማማኝ።",
  ...
  ti: {
    ...
    hero: {
      ...
      subtitle: "ካብ 1 ክሳብ ዝመረጽኩሞ መጠን ተሳተፍቲ ዝፈትውዎ ቁጽሪ ምረጹ፣ ብቴሌብር ወይ ብሲቢኢ ብር ክፈሉ፣ ኣብ መዓልቲ ዕጫ ናይ ቀጥታ ቪድዮ ዕጫ ተኸታተሉ። 100% ግልጺን ውሑስን።",
