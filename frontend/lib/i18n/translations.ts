...
export const translations: Record<Language, Translations> = {
  en: {
    appName: "PrimeDraws",
    tagline: "Cryptographically Verifiable Digital Lottery & Raffle Platform",
    nav: {
      draws: "Draws",
      enter: "Enter Draw",
  ...
  am: {
    ...
    footer: {
      description: "ፕራይም ድሮውስ በክሪፕቶግራፊ ጥበቃ እና በግልጽ አሰራር ላይ የተመሰረተ ዘመናዊ የዲጂታል ሎተሪ አገልግሎት ነው።",
      rights: "መብቱ በህግ የተጠበቀ ነው። ዲጂታል ሎተሪ ኦፕሬሽንስ።",
      support: "የደንበኞች አገልግሎት: +251 911 000 000 · support@primedraws.com",
  ...
  om: {
    ...
    promo: {
      badge: "QOPHII ADDAA & BEEKSIISA",
      viewAllDeals: "Qophiilee Hunda Ilaalaa",
      exclusive: "Jaakpootii Ayyaanaa",
      limitedTime: "Yeroo Murtaa'e Qofa",
      getDeal: "Carraa Fadhau",
    },
    drawsExplorer: {
      title: "Kaatalaagii Carraawwanii",
      subtitle: "Carraawwan banaa amma jiran, kan fuulduraa fi bu'aa carraawwan darban mirkaneeffadhaa.",
      tabCurrent: "Carraawwan Ammaa",
      tabUpcoming: "Carraawwan Dhufan",
      tabPast: "Bu'aawwan Darban",
      searchPlaceholder: "Badhaasaan, lakkoofsaan ykn mata dureen barbaadi...",
      allCategories: "Badhaasota Hunda",
      prizePool: "Gatii Badhaasa Waliigalaa",
      ticketPrice: "Gatii Tikkeettii",
      entriesTotal: "Tikkeettii Mirkanaa'an",
      drawDate: "Guyyaa Carraa",
      winningNumbers: "Lakkoofsa Mo'ate",
      enterNow: "Carraa Kanaan Hiri'adhaa",
      viewDetails: "Bal'ina Ilaalaa",
      verifyResults: "Bu'aa Mirkaneessaa",
      startsIn: "Kan Banamu",
      completedOn: "Kan Xumurame",
      noDrawsFound: "Carraan barbaaddan hin jiru.",
      filterBy: "Haalaan Calali",
      statusOpen: "Banaa & Hojii Irra",
      statusUpcoming: "Dhiyootti Banama",
      statusRevealed: "Mirkanaa'ee Xumurame",
      seedHash: "Koodii Haashii",
    },
    prizes: {
