...
export const translations: Record<Language, Translations> = {
  ...
  en: {
    ...
    hero: {
      liveBadge: "PLAY • WIN • LIVE BIGGER",
      title: "Your Next Big Win Is Closer Than You Think",
      subtitle: "Play official digital lottery games anytime, anywhere. It's safe, simple, and full of opportunity.",
    ...
    quickPick: {
      ...
      subtitle: "Select an available number within your chosen pool or generate a balanced random pick.",
      selectedNumber: "Selected Number",
      randomPick: "Random Pick",
      checkOdds: "Test Availability",
      instantEnter: "Proceed With Number",
      hint: "Choose one available number from your selected pool. Submitted numbers are reserved while payments are reviewed.",
      availability: "Status",
      available: "Available",
      ...
      steps: [
        {
          ...
          description: "Choose an available number from 1 to your selected pool capacity, or click Quick Pick for an instant selection. Select your preferred ticket price (100, 200, 500, or 1,000 ETB) and capped participant pool (1K, 2K, 3K, or 5K).",
          highlights: [
        ...
        },
        {
          ...
          highlights: [
            ...
            "Save the submission reference shown after your receipt is uploaded.",
          ],
        },
        {
          stepNumber: "03",
    ...
    ticketModal: {
      ...
      chooseNumber: "Choose an Available Ticket Number",
  ...
  am: {
    ...
    hero: {
      liveBadge: "ይጫወቱ • ያሸንፉ • ህይወትዎን ያሳድጉ",
      title: "የሚቀጥለው ትልቅ ድልዎ ካሰቡት በላይ ቅርብ ነው",
      subtitle: "ኦፊሴላዊ የዲጂታል ሎተሪ ጨዋታዎችን በማንኛውም ጊዜ እና ቦታ ይጫወቱ። ደህንነቱ የተጠበቀ፣ ቀላል እና በዕድል የተሞላ ነው።",
    ...
    quickPick: {
      title: "የቁጥር መምረጫ ሰሌዳ",
      subtitle: "የሚፈልጉትን ያልተያዘ ቁጥር ይምረጡ ወይም በአጋጣሚ ቁጥር መራጭ ያግኙ።",
      ...
      steps: [
        {
          ...
          description: "ከ1 እስከ መረጡት የተሳታፊ ገደብ የሚወዱትን ያልተያዘ ቁጥር ይምረጡ ወይም በአጋጣሚ መራጭ ይጠቀሙ። የቲኬት ዋጋ (100፣ 200፣ 500፣ ወይም 1,000 ብር) እና የተሳታፊ ገደብ (1ሺህ፣ 2ሺህ፣ 3ሺህ፣ ወይም 5ሺህ) ይምረጡ።",
          highlights: [
  ...
  ti: {
    ...
    hero: {
      liveBadge: "ተጻወቱ • ተዓወቱ • ህይወትኩም ኣዕብዩ",
      title: "ዝቕጽል ዓቢ ዓወትኩም ካብቲ ዝሓሰብኩምዎ ንላዕሊ ቀረባ እዩ",
      subtitle: "ወግዓዊ ናይ ዲጂታል ሎተሪ ጸወታታት ኣብ ዝኾነ ግዜን ቦታን ተጻወቱ። ውሑስ፣ ቀሊልን ዕድል ዝመልኦን እዩ።",
    ...
    quickPick: {
      title: "መመርጺ ሰሌዳ ቁጽሪ",
      subtitle: "ዝደለይዎ ዘይተያዝ ቁጽሪ ምረጹ ወይ ብዕጫ ቁጽሪ ኣውጽኡ።",
    ...
    howItWorks: {
      ...
      step1: "1. ቁጽርኹም ምረጹ",
      step1Desc: "ካብ 1 ክሳብ ዝመረጽኩሞ መጠን ተሳተፍቲ ዝፈትውዎ ወይ ዕድለኛ ቁጽርኹም ምረጹ።",
      step2: "2. ክፍሊት ፈጽሙ",
      ...
      steps: [
        {
          ...
          description: "ካብ 1 ክሳብ ዝመረጽኩሞ መጠን ተሳተፍቲ ዝፈትውዎ ዘይተያዝ ቁጽሪ ምረጹ ወይ ብዕጫ መውጽኢ ተጠቐሙ። ዋጋ ቲኬት (100፣ 200፣ 500፣ ወይ 1,000 ብር) ከምኡ'ውን መጠን ተሳተፍቲ (1ሺሕ፣ 2ሺሕ፣ 3ሺሕ፣ ወይ 5ሺሕ) ምረጹ።",
          highlights: [
